...
CreateRaster2 <- function(Zone_SHP,
                          Buffer_Width=1000,
                          ParamRAS_DF,
                          res_tile=20,
  ...
  Xlsx_FILE <- "/Users/Valentin/Foret/Travail/PNRVN/Ilots_PNRVN/Out/Excel/Parametres_SIG_bis.xlsx"
  # wb <- loadWorkbook(Xlsx_FILE)
  ListSheets <- getSheetNames(Xlsx_FILE)
  ...
  df <- read.xlsx(Xlsx_FILE,sheet=sheet)
